...
ROOT_URLCONF = 'control_visitas.urls'

WSGI_APPLICATION = 'control_visitas.wsgi.application'
...
STATIC_ROOT = '/home/administrador/django/control_visitas/static/'

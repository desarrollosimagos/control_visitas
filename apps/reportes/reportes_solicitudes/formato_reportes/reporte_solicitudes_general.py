...
def reporte_solicitudes_general(id_inst,tipo,estado,desde,hasta,sexo,grupo,motivo,municipio,ocupacion,tipo_edu,organizacion,sector,dependencia):
        ...
        if tipo == '1':
                ...
                sql_mun = "SELECT municipio FROM municipios_municipio WHERE id=%s"
        ...
        if tipo == '12':
                ...
                pdf.cell(13,5,"Cédula".decode("UTF-8"),'LTBR',0,'C',1)
                pdf.cell(63,5,"Nombre y Apellido".decode("UTF-8"),'LTBR',0,'C',1)
                pdf.cell(50,5,"Motivo".decode("UTF-8"),'LTBR',0,'C',1)
                pdf.cell(14,5,"Fecha".decode("UTF-8"),'LTBR',0,'C',1)
        ...
        if tipo == '11':
                ...
                sql_sop += "  (SELECT municipio FROM municipios_municipio WHERE id=s.municipio) municipio, "
        ...
        for t in row:
                ...
                if tipo == '12':
                        ...
                        pdf.set_y(75+o)
                        pdf.set_x(15)
                        pdf.cell(13,a,str(t['cedula']),'LTBR',0,'C',1)
                        pdf.set_y(75+o)
                        pdf.set_x(28)
                        pdf.cell(63,a,str(t['nombre'])+' '+str(t['apellido']).decode("UTF-8"),'LTBR',0,'L',1)
                        pdf.set_y(75+o)
                        pdf.set_x(91)
                        pdf.cell(50,a,str(t['motivo']).decode("UTF-8"),'LTBR',0,'C',1)
                        pdf.set_y(75+o)
                        pdf.set_x(141)
                        pdf.cell(14,a,str(fecha).decode("UTF-8"),'LTBR',1,'L',1)
                        pdf.set_y(75+o)
                        pdf.set_x(155)

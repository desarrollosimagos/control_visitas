...
class ReporteCandidato(FPDF):
	...
	def header(self):
		...
		self.image(ruta+'/img/tope.jpg',15,15,250)
	...
	def footer(self):
		...
		self.cell(215,5,'www.control_visitas.org.ve',0,0,'R')  
...
class ReporteFicha(FPDF):
	...
	def footer(self):
		...
		#Numero de pagina
		fecha_hora = time.strftime("%d/%m/%Y")+" "+time.strftime("%I:%M %p")
		self.cell(30,5,fecha_hora,0,0,'R')
		self.cell(155,5,'www.control_visitas.org.ve'+' '+'(Pag. '+str(self.page_no())+')',0,0,'R')  
		# self.cell(160,25,'Pagina '+str(self.page_no()),0,0,'R') 
